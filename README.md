...
Data Dictionary is a small library I wrote for Spark. It essentially is an abstraction layer that allows you to manage a large number of data sources from separate APIs in a lightweight manner. It has a list of all the APIs you bring in and can enact the same transformation across multiple dataframes built from those APIs. This allows you to very quickly create a pipeline for the Bronze to Silver layer for basic data cleaning tasks.
